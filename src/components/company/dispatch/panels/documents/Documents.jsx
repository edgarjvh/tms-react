...
function Documents(props) {
    ...
    const tagsOnKeydown = (e) => {
        ...
        if (keyCode === 13) {
            props.setSelectedOrderDocument({ ...props.selectedOrderDocument, tags: (props.selectedOrderDocument.tags || '') === '' ? props.orderDocumentTags : props.selectedOrderDocument.tags + '|' + props.orderDocumentTags });
    ...
    const quickTypeLinkClasses = classnames({
        ...
        'disabled': (props.selectedOrderDocument.id || 0) > 0
    });
