...
function CarrierInfoContacts(props) {    
    ...
    const borderBottomClasses = classnames({
        ...
        'disabled': !props.dispatchCarrierInfoIsEditingContact
    });
        ...
        $.post(props.serverUrl + '/saveCarrierContact', contact).then(async res => {
            if (res.result === 'OK') {
                ...
                if (props.selectedDispatchCarrierInfoContact.id !== undefined) {
                    if (props.selectedDispatchCarrierInfoContact.id === contact.id) {
                        await props.setSelectedDispatchCarrierInfoContact(res.contact);
                    }
                }

                await props.setDispatchCarrierInfoContactSearchCarrier({ ...props.carrier, selectedContact: res.contact, contacts: res.contacts });

                props.setDispatchCarrierInfoIsEditingContact(false);
            }
        });
    }
        ...
        if (window.confirm('Are you sure to delete this contact?')) {
            $.post(props.serverUrl + '/deleteCarrierContact', contact).then(async res => {
                if (res.result === 'OK') {
                    ...
                    await props.setDispatchCarrierInfoContactSearchCarrier({ ...props.carrier, selectedContact: {}, contacts: res.contacts });
                                        ...
                                        return (
                                            <div key={index}>
                                                ...
                                                <div className="row-contact" onClick={async () => {
                                                    await props.setDispatchCarrierInfoContactSearchCarrier({ ...props.carrier, selectedContact: contact });
                                                    props.setDispatchCarrierInfoIsEditingContact(false);
                                                }}>
                ...
                <div className="contact-form">
                    <div className="contact-form-header">
                        <div className="contact-avatar-container">
                            ...
                            {
                                (props.dispatchCarrierInfoIsEditingContact && (props.carrier.selectedContact?.id || 0) > 0 && (props.carrier.selectedContact?.avatar || '') !== '') && <span className="fas fa-trash-alt remove-contact-avatar-btn" onClick={removeContactAvatar}></span>
                            }
                            {
                                (props.dispatchCarrierInfoIsEditingContact && (props.carrier.selectedContact?.id || 0) > 0) && <span className="fas fa-sync change-contact-avatar-btn" onClick={() => {refInputAvatar.current.click()}}></span>
                            }
                        ...
                        <div className="contact-info">
                            ...
                            <div className="contact-company">
                                <span>
                                    {props.carrier.selectedContact.id !== undefined ? props.carrier.name : ''}
                                </span>
                                
                                <span>
                                    {(props.carrier.selectedContact.title || '')}
                                </span>
                                
                                <span>
                                    {(props.carrier.selectedContact.department || '')}
                                </span>
                            </div>                        </div>
                            ...
                            <div className="input-toggle-container">
                                <input type="checkbox" id="cbox-panel-carrier-info-contacts-primary-btn"
                                    onChange={e => {
                                        ...
                                        props.setDispatchCarrierInfoContactSearchCarrier({ ...props.carrier, selectedContact: contact });
                                    }}
                                    disabled={!props.dispatchCarrierInfoIsEditingContact}
                    ...
                    <div className="contact-form-fields">
                        <div className="contact-form-wrapper">
                            <div className="field-container">
                                ...
                                <input ref={refPrefix} type="text" readOnly={!props.dispatchCarrierInfoIsEditingContact}
                                    onChange={e => {
                                        let contact = props.carrier.selectedContact;
                            ...
                            <div className="field-container">
                                ...
                                <input type="text" readOnly={!props.dispatchCarrierInfoIsEditingContact}
                                    onChange={e => {
                                        let contact = props.carrier.selectedContact;
                ...
                <div className="footer">
                    <div className="left-buttons">
                        <div className="mochi-button" onClick={() => {
                            props.setDispatchCarrierInfoContactSearchCarrier({...props.carrier, selectedContact: {id: 0, carrier_id: props.carrier.id}});
                    ...
                    <div className="right-buttons">
                        {
                            props.dispatchCarrierInfoIsEditingContact &&
                            <span className="fas fa-save" onClick={saveCarrierContact}></span>
                        }
                        {
                            !props.dispatchCarrierInfoIsEditingContact &&
                            <span className="fas fa-pencil-alt" onClick={() => { props.setDispatchCarrierInfoIsEditingContact(true) }} style={{
