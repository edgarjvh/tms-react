                            ...
                            <div className="form-bordered-box">
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, name: e.target.value })} value={props.selectedShipperCompanyInfo.name || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Address 1" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, address1: e.target.value })} value={props.selectedShipperCompanyInfo.address1 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Address 2" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, address2: e.target.value })} value={props.selectedShipperCompanyInfo.address2 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="City" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, city: e.target.value })} value={props.selectedShipperCompanyInfo.city || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-state">
                                        <input type="text" readOnly={true} placeholder="State" maxLength="2" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, state: e.target.value })} value={props.selectedShipperCompanyInfo.state || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-zip-code">
                                        <input type="text" readOnly={true} placeholder="Postal Code" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, zip: e.target.value })} value={props.selectedShipperCompanyInfo.zip || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Contact Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, contact_name: e.target.value })} value={props.selectedShipperCompanyInfo.contact_name || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    ...
                                    <div className="input-box-container input-phone-ext">
                                        <input type="text" readOnly={true} placeholder="Ext" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, ext: e.target.value })} value={props.selectedShipperCompanyInfo.ext || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="E-Mail" style={{ textTransform: 'lowercase' }} onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, email: e.target.value })} value={props.selectedShipperCompanyInfo.email || ''} />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="fields-container-col" style={{ display: 'flex' }}>
                            <div className="form-bordered-box">
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_name: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_name || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Address 1" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_address1: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_address1 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Address 2" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_address2: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_address2 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="City" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_city: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_city || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-state">
                                        <input type="text" readOnly={true} placeholder="State" maxLength="2" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_state: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_state || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-zip-code">
                                        <input type="text" readOnly={true} placeholder="Postal Code" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_zip: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_zip || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Contact Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_contact_name: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_contact_name || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-phone">
                                        <MaskedInput
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-phone-ext">
                                        <input type="text" readOnly={true} placeholder="Ext" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_ext: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_ext || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="E-Mail" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_email: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_email || ''} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="form-borderless-box" style={{ width: '170px', marginLeft: '10px', }}>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} style={{ textTransform: 'uppercase' }} placeholder="Bill To" readOnly={true} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_bill_to: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_bill_to || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                    ...
                    <div className="fields-container-row">
                        <div className="fields-container-col">
                            <div className="form-bordered-box">
                                ...
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        ...
                                        <input type="text" readOnly={true} placeholder="First Name" onKeyDown={validateContactForSaving} onChange={e => {
                                            ...
                                            props.setSelectedContact({ ...props.selectedShipperCompanyContact, first_name: e.target.value })
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Last Name" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedContact({ ...props.selectedShipperCompanyContact, last_name: e.target.value })} value={props.selectedShipperCompanyContact.last_name || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container" style={{ width: '50%' }}>
                                        <MaskedInput
                                            mask={[/[0-9]/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]}
                                            guide={true}
                                            type="text" placeholder="Phone" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedContact({ ...props.selectedShipperCompanyContact, phone_work: e.target.value })} value={props.selectedShipperCompanyContact.phone_work || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div style={{ width: '50%', display: 'flex', justifyContent: 'space-between' }}>
                                        <div className="input-box-container input-phone-ext">
                                            <input type="text" readOnly={true} placeholder="Ext" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedContact({ ...props.selectedShipperCompanyContact, phone_ext: e.target.value })} value={props.selectedShipperCompanyContact.phone_ext || ''} />
                                        </div>
                                        <div className="input-toggle-container">
                                            <input type="checkbox" readOnly={true} id="cbox-customer-contacts-primary-btn" checked={(props.selectedShipperCompanyContact.is_primary || 0) === 1} />
                                ...
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="E-Mail" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedContact({ ...props.selectedShipperCompanyContact, email_work: e.target.value })} value={props.selectedShipperCompanyContact.email_work || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Notes" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedContact({ ...props.selectedShipperCompanyContact, notes: e.target.value })} value={props.selectedShipperCompanyContact.notes || ''} />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="fields-container-col">
                            <div className="form-bordered-box">
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-toggle-container">
                                        <input type="checkbox" readOnly={true} id="cbox-automatic-emails-booked-load-btn" checked={(props.selectedShipperCompanyInfo.automatic_emails?.automatic_emails_booked_load || 0) === 1} />
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-toggle-container">
                                        <input type="checkbox" readOnly={true} id="cbox-automatic-emails-check-calls-btn" checked={(props.selectedShipperCompanyInfo.automatic_emails?.automatic_emails_check_calls || 0) === 1} />
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-toggle-container">
                                        <input type="checkbox" readOnly={true} id="cbox-automatic-emails-carrier-arrival-shipper-btn" checked={(props.selectedShipperCompanyInfo.automatic_emails?.automatic_emails_carrier_arrival_shipper || 0) === 1} />
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-toggle-container">
                                        <input type="checkbox" readOnly={true} id="cbox-automatic-emails-carrier-arrival-consignee-btn" checked={(props.selectedShipperCompanyInfo.automatic_emails?.automatic_emails_carrier_arrival_consignee || 0) === 1} />
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-toggle-container">
                                        <input type="checkbox" readOnly={true} id="cbox-automatic-emails-loaded-btn" checked={(props.selectedShipperCompanyInfo.automatic_emails?.automatic_emails_loaded || 0) === 1} />
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-toggle-container">
                                        <input type="checkbox" readOnly={true} id="cbox-automatic-emails-empty-btn" checked={(props.selectedShipperCompanyInfo.automatic_emails?.automatic_emails_empty || 0) === 1} />
                                                    ...
                                                    (props.selectedShipperCompanyInfo.contacts || []).map((contact, index) => {
                                                        return (
                                                            <div className="contact-list-item" key={index} onDoubleClick={async () => {
                                                                ...
                                                                await props.setContactSearchCustomer({ ...props.selectedShipperCompanyInfo, selectedContact: contact });
