...
function ShipperCompanyInfo(props) {
    ...
    const setInitialValues = (clearCode = true) => {
        ...
        props.setSelectedShipperCompanyNote({});
        props.setSelectedShipperCompanyDirection({});
        props.setShipperCompanyContactSearch({});

        props.setShipperCompanyShowingContactList(true);
        props.setShipperCompanyAutomaticEmailsTo('');
        props.setShipperCompanyAutomaticEmailsCc('');
        props.setShipperCompanyAutomaticEmailsBcc('');
        props.setSelectedShipperCompanyInfo({ id: -1, code: clearCode ? '' : props.selectedShipperCompanyInfo.code });
        setPopupItems([]);
    }
                ...
                $.post(props.serverUrl + '/customers', {
                    ...
                    if (res.result === 'OK') {
                        if (res.customers.length > 0) {
                            ...
                            await props.setSelectedShipperCompanyInfo(res.customers[0]);

                            await res.customers[0].contacts.map(async c => {
                                if (c.is_primary === 1) {
                                    await props.setSelectedShipperCompanyContact(c);
                                }
                                return true;
                            });
                            ...
                            if (res.result === 'OK') {
                                if (props.selectedShipperCompanyInfo.id === undefined || (props.selectedShipperCompanyInfo.id || 0) === 0) {
                                    ...
                                    if (res.customer.contacts[0].is_primary === 1) {
                                        await props.setSelectedShipperCompanyContact(res.customer.contacts[0]);
                                    }
                                }
                            }
    ...
    const selectedContactIsPrimaryChange = async (e) => {
        await props.setSelectedShipperCompanyContact({ ...props.selectedShipperCompanyContact, is_primary: e.target.checked ? 1 : 0 });
    ...
    const popupItemClick = async (item) => {
        ...
        await props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, automatic_emails: automaticEmails });
    ...
    const automaticEmailsOnInput = async (e, name) => {
        window.clearTimeout(delayTimer);
        name === 'to' && props.setShipperCompanyAutomaticEmailsTo(e.target.value);
        name === 'cc' && props.setShipperCompanyAutomaticEmailsCc(e.target.value);
        name === 'bcc' && props.setShipperCompanyAutomaticEmailsBcc(e.target.value);
    ...
    const validateHoursForSaving = (e, name) => {
        ...
        $.post(props.serverUrl + '/saveCustomerHours', hours).then(async res => {
            if (res.result === 'OK') {
                await props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, hours: res.customer_hours });
            }
        })
    }
                    ...
                    <div className="fields-container-row">
                        <div className="fields-container-col">
                            <div className="form-bordered-box">
                                ...
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={3 + props.tabTimes} type="text" placeholder="Address 1" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, address1: e.target.value })} value={props.selectedShipperCompanyInfo.address1 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={4 + props.tabTimes} type="text" placeholder="Address 2" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, address2: e.target.value })} value={props.selectedShipperCompanyInfo.address2 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={5 + props.tabTimes} type="text" placeholder="City" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, city: e.target.value })} value={props.selectedShipperCompanyInfo.city || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-state">
                                        <input tabIndex={6 + props.tabTimes} type="text" placeholder="State" maxLength="2" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, state: e.target.value })} value={props.selectedShipperCompanyInfo.state || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-zip-code">
                                        <input tabIndex={7 + props.tabTimes} type="text" placeholder="Postal Code" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, zip: e.target.value })} value={props.selectedShipperCompanyInfo.zip || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={8 + props.tabTimes} type="text" placeholder="Contact Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, contact_name: e.target.value })} value={props.selectedShipperCompanyInfo.contact_name || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-phone">
                                        <MaskedInput
                                            ...
                                            guide={true}
                                            type="text" placeholder="Contact Phone" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, contact_phone: e.target.value })} value={props.selectedShipperCompanyInfo.contact_phone || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-phone-ext">
                                        <input tabIndex={10 + props.tabTimes} type="text" placeholder="Ext" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, ext: e.target.value })} value={props.selectedShipperCompanyInfo.ext || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={11 + props.tabTimes} type="text" placeholder="E-Mail" style={{ textTransform: 'lowercase' }} onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, email: e.target.value })} value={props.selectedShipperCompanyInfo.email || ''} />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="fields-container-col" style={{ display: 'flex' }}>
                                ...
                                <div className="form-row">
                                    <div className="input-box-container input-code">
                                        <input tabIndex={12 + props.tabTimes} type="text" placeholder="Code" maxLength="8"
                                            onKeyDown={validateCustomerForSaving}
                                            onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_code: e.target.value })}
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container grow">
                                        <input tabIndex={13 + props.tabTimes} type="text" placeholder="Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_name: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_name || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={14 + props.tabTimes} type="text" placeholder="Address 1" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_address1: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_address1 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={15 + props.tabTimes} type="text" placeholder="Address 2" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_address2: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_address2 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={16 + props.tabTimes} type="text" placeholder="City" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_city: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_city || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-state">
                                        <input tabIndex={17 + props.tabTimes} type="text" placeholder="State" maxLength="2" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_state: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_state || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-zip-code">
                                        <input tabIndex={18 + props.tabTimes} type="text" placeholder="Postal Code" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_zip: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_zip || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={19 + props.tabTimes} type="text" placeholder="Contact Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_contact_name: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_contact_name || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-phone">
                                        <MaskedInput tabIndex={20 + props.tabTimes}
                                            mask={[/[0-9]/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]}
                                            guide={true}
                                            type="text" placeholder="Contact Phone" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_contact_phone: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_contact_phone || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-phone-ext">
                                        <input tabIndex={21 + props.tabTimes} type="text" placeholder="Ext" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_ext: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_ext || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={22 + props.tabTimes} type="text" placeholder="E-Mail" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_email: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_email || ''} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="form-borderless-box" style={{ width: '170px', marginLeft: '10px', }}>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={32 + props.tabTimes} type="text" style={{ textTransform: 'uppercase' }} placeholder="Bill To" readOnly={true} onChange={e => props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, mailing_bill_to: e.target.value })} value={props.selectedShipperCompanyInfo.mailing_bill_to || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                            ...
                            <div className="form-bordered-box">
                                <div className="form-header">
                                    ...
                                    <div className="form-buttons">
                                        ...
                                        <div className="mochi-button" onClick={() => props.setSelectedShipperCompanyContact({})}>
                                            <div className="mochi-button-decorator mochi-button-decorator-left">(</div>
                                            <div className="mochi-button-base">Clear</div>
                                            <div className="mochi-button-decorator mochi-button-decorator-right">)</div>
                                        </div>
                                ...
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={23 + props.tabTimes} type="text" placeholder="First Name" onKeyDown={validateContactForSaving} onChange={e => {
                                            ...
                                            props.setSelectedShipperCompanyContact({ ...props.selectedShipperCompanyContact, first_name: e.target.value })
                                        }} value={props.selectedShipperCompanyContact.first_name || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container grow">
                                        <input tabIndex={24 + props.tabTimes} type="text" placeholder="Last Name" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedShipperCompanyContact({ ...props.selectedShipperCompanyContact, last_name: e.target.value })} value={props.selectedShipperCompanyContact.last_name || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container" style={{ width: '50%' }}>
                                        <MaskedInput tabIndex={25 + props.tabTimes}
                                            mask={[/[0-9]/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]}
                                            guide={true}
                                            type="text" placeholder="Phone" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedShipperCompanyContact({ ...props.selectedShipperCompanyContact, phone_work: e.target.value })} value={props.selectedShipperCompanyContact.phone_work || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div style={{ width: '50%', display: 'flex', justifyContent: 'space-between' }}>
                                        <div className="input-box-container input-phone-ext">
                                            <input tabIndex={26 + props.tabTimes} type="text" placeholder="Ext" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedShipperCompanyContact({ ...props.selectedShipperCompanyContact, phone_ext: e.target.value })} value={props.selectedShipperCompanyContact.phone_ext || ''} />
                                        </div>
                                ...
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={27 + props.tabTimes} type="text" placeholder="E-Mail" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedShipperCompanyContact({ ...props.selectedShipperCompanyContact, email_work: e.target.value })} value={props.selectedShipperCompanyContact.email_work || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container grow">
                                        <input tabIndex={28 + props.tabTimes} type="text" placeholder="Notes" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedShipperCompanyContact({ ...props.selectedShipperCompanyContact, notes: e.target.value })} value={props.selectedShipperCompanyContact.notes || ''} />
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div key={index} style={{
                                                            ...
                                                            <span className="fas fa-trash-alt" style={{ marginRight: '5px', cursor: 'pointer' }}
                                                                onClick={() => {
                                                                    ...
                                                                    props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, automatic_emails: automatic_emails });
                                    ...
                                    <div className="form-buttons">
                                        {
                                            ...
                                            <div className="mochi-button" onClick={() => props.setShipperCompanyShowingContactList(false)}>
                                                <div className="mochi-button-decorator mochi-button-decorator-left">(</div>
                                                <div className="mochi-button-base">Search</div>
                                                <div className="mochi-button-decorator mochi-button-decorator-right">)</div>
                                            </div>
                                        ...
                                        {
                                            !props.shipperCompanyShowingContactList &&
                                            <div className="mochi-button" onClick={() => props.setShipperCompanyShowingContactList(true)}>
                                                <div className="mochi-button-decorator mochi-button-decorator-left">(</div>
                                ...
                                <div className="form-slider">
                                    <div className="form-slider-wrapper" style={{ left: props.shipperCompanyShowingContactList ? 0 : '-100%' }}>
                                        ...
                                        <div className="contact-search-box">
                                            <div className="form-row">
                                                <div className="input-box-container grow">
                                                    <input type="text" placeholder="First Name" onChange={e => props.setShipperCompanyContactSearch({ ...props.shipperCompanyContactSearch, first_name: e.target.value })} value={props.shipperCompanyContactSearch.first_name || ''} />
                                                </div>
                                                <div className="form-h-sep"></div>
                                                <div className="input-box-container grow">
                                                    <input type="text" placeholder="Last Name" onFocus={() => { props.setShipperCompanyShowingContactList(false) }} onChange={e => props.setShipperCompanyContactSearch({ ...props.shipperCompanyContactSearch, last_name: e.target.value })} value={props.shipperCompanyContactSearch.last_name || ''} />
                                                </div>
                                            </div>
                                            <div className="form-v-sep"></div>
                                            <div className="form-row">
                                                <div className="input-box-container grow">
                                                    <input type="text" placeholder="Address 1" onFocus={() => { props.setShipperCompanyShowingContactList(false) }} onChange={e => props.setShipperCompanyContactSearch({ ...props.shipperCompanyContactSearch, address1: e.target.value })} value={props.shipperCompanyContactSearch.address1 || ''} />
                                                </div>
                                            </div>
                                            <div className="form-v-sep"></div>
                                            <div className="form-row">
                                                <div className="input-box-container grow">
                                                    <input type="text" placeholder="Address 2" onFocus={() => { props.setShipperCompanyShowingContactList(false) }} onChange={e => props.setShipperCompanyContactSearch({ ...props.shipperCompanyContactSearch, address2: e.target.value })} value={props.shipperCompanyContactSearch.address2 || ''} />
                                                </div>
                                            </div>
                                            <div className="form-v-sep"></div>
                                            <div className="form-row">
                                                <div className="input-box-container grow">
                                                    <input type="text" placeholder="City" onFocus={() => { props.setShipperCompanyShowingContactList(false) }} onChange={e => props.setShipperCompanyContactSearch({ ...props.shipperCompanyContactSearch, city: e.target.value })} value={props.shipperCompanyContactSearch.city || ''} />
                                                </div>
                                                <div className="form-h-sep"></div>
                                                <div className="input-box-container input-state">
                                                    <input type="text" placeholder="State" maxLength="2" onFocus={() => { props.setShipperCompanyShowingContactList(false) }} onChange={e => props.setShipperCompanyContactSearch({ ...props.shipperCompanyContactSearch, state: e.target.value })} value={props.shipperCompanyContactSearch.state || ''} />
                                                </div>
                                                <div className="form-h-sep"></div>
                                                <div className="input-box-container grow">
                                                    <MaskedInput
                                                        mask={[/[0-9]/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]}
                                                        guide={true}
                                                        type="text" placeholder="Phone (Work/Mobile/Fax)" onFocus={() => { props.setShipperCompanyShowingContactList(false) }} onChange={e => props.setShipperCompanyContactSearch({ ...props.shipperCompanyContactSearch, phone: e.target.value })} value={props.shipperCompanyContactSearch.phone || ''} />
                                                </div>
                                            </div>
                                            <div className="form-v-sep"></div>
                                            <div className="form-row">
                                                <div className="input-box-container grow">
                                                    <input type="text" placeholder="E-Mail" style={{ textTransform: 'lowercase' }}
                                                        ...
                                                        onFocus={() => { props.setShipperCompanyShowingContactList(false) }}
                                                        onChange={e => props.setShipperCompanyContactSearch({ ...props.shipperCompanyContactSearch, email: e.target.value })}
                                        ...
                                        <div className="input-box-container ">
                                            <input tabIndex={39 + props.tabTimes} type="text" placeholder="Open"
                                                ...
                                                onChange={e => {
                                                    ...
                                                    props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, hours: hours });
                                                }}
                        ...
                        <div className="fields-container-col">
                            <div className="form-bordered-box" >
                                <div className="form-header">
                                    ...
                                    <div className="top-border top-border-middle"></div>
                                    <div className="form-buttons">
                                        <div className="mochi-button" onClick={() => props.setSelectedShipperCompanyNote({ id: 0, customer_id: props.selectedShipperCompanyInfo.id })}>
                                            <div className="mochi-button-decorator mochi-button-decorator-left">(</div>
                                    ...
                                    <div className="notes-list-wrapper">
                                        {
                                            (props.selectedShipperCompanyInfo.notes || []).map((note, index) => {
                                                return (
                                                    <div className="notes-list-item" key={index} onClick={() => props.setSelectedShipperCompanyNote(note)}>
                                                        {note.text}
                                                    </div>
                                                )
                                            })
                        ...
                        <div className="fields-container-col">
                            <div className="form-bordered-box" >
                                <div className="form-header">
                                    ...
                                    <div className="top-border top-border-middle"></div>
                                    <div className="form-buttons">
                                        <div className="mochi-button" onClick={() => props.setSelectedShipperCompanyDirection({ id: 0, customer_id: props.selectedShipperCompanyInfo.id })}>
                                            <div className="mochi-button-decorator mochi-button-decorator-left">(</div>
                                    ...
                                    <div className="directions-list-wrapper">
                                        {
                                            (props.selectedShipperCompanyInfo.directions || []).map((direction, index) => {
                                                return (
                                                    <div className="directions-list-item" key={index} onClick={() => props.setSelectedShipperCompanyDirection(direction)}>
                                                        {direction.text}
                                                    </div>
                                                )
                                            })
...

            {
                ...
                <animated.div style={modalTransitionProps}>
                    <CustomerModal
                        ...
                        setSelectedData={props.setSelectedShipperCompanyNote}
                        selectedParent={props.selectedShipperCompanyInfo}
                        setSelectedParent={(notes) => {
                            props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, notes: notes });
                        }}
...

            {
                ...
                <animated.div style={modalTransitionProps}>
                    <CustomerModal
                        ...
                        setSelectedData={props.setSelectedShipperCompanyDirection}
                        selectedParent={props.selectedShipperCompanyInfo}
                        setSelectedParent={(directions) => {
                            props.setSelectedShipperCompanyInfo({ ...props.selectedShipperCompanyInfo, directions: directions });
                        }}
...
const mapStateToProps = state => {
    return {
        ...
        shipperCompanyDocumentTags: state.customerReducers.shipperCompanyDocumentTags,
