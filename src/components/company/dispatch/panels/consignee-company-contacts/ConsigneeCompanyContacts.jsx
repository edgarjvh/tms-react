...
function ConsigneeCompanyContacts(props) {    
    ...
    const saveContact = () => {
        ...
        $.post(props.serverUrl + '/saveContact', contact).then(async res => {
            if (res.result === 'OK') {
                ...
                await props.setConsigneeCompanyContactSearchCustomer({ ...props.customer, selectedConsigneeCompanyContact: res.contact, contacts: res.contacts });

                props.setConsigneeCompanyIsEditingContact(false);
            }
        });
    }
        ...
        if (window.confirm('Are you sure to delete this contact?')) {
            $.post(props.serverUrl + '/deleteContact', contact).then(async res => {
                if (res.result === 'OK') {
                    ...
                    await props.setConsigneeCompanyContactSearchCustomer({ ...props.customer, selectedConsigneeCompanyContact: {}, contacts: res.contacts });
    ...
    return (
        <div className="panel-content">
            ...
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'consignee-company-contacts')}><span className="fas fa-times"></span></div>
                                        ...
                                        return (
                                            <div key={index}>
                                                ...
                                                <div className="row-contact" onClick={async () => {
                                                    await props.setConsigneeCompanyContactSearchCustomer({ ...props.customer, selectedConsigneeCompanyContact: contact });
                                                    props.setConsigneeCompanyIsEditingContact(false);
                                                }}>
                            ...
                            <div className="input-toggle-container">
                                <input type="checkbox" id="cbox-panel-customer-contacts-primary-btn"
                                    onChange={e => {
                                        ...
                                        props.setConsigneeCompanyContactSearchCustomer({ ...props.customer, selectedConsigneeCompanyContact: contact });
                                    }}
                                    disabled={!props.consigneeCompanyIsEditingContact}
                ...
                <div className="footer">
                    <div className="left-buttons">
                        <div className="mochi-button" onClick={() => {
                            props.setConsigneeCompanyContactSearchCustomer({...props.customer, selectedConsigneeCompanyContact: {id: 0, customer_id: props.customer.id}});
                    ...
                    <div className="right-buttons">
                        ...
                        {
                            !props.consigneeCompanyIsEditingContact &&
                            <span className="fas fa-pencil-alt" onClick={() => { props.setConsigneeCompanyIsEditingContact(true) }} style={{
...
const mapStateToProps = state => {
    return {
        ...
        customer: state.customerReducers.consigneeCompanyContactSearchCustomer,
