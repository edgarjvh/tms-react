...
function CarrierInfoSearchChanging(props) {
    ...
    const rowDoubleClick = async (e, c) => {
        ...
        closePanelBtnClick(null, 'carrier-info-search-changing');
    }

    return (
        <div className="panel-content">
            <div className="drag-handler" onClick={e => e.stopPropagation()}></div>
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'carrier-info-search-changing')}><span className="fas fa-times"></span></div>
