...
function CarrierInfoDocuments(props) {
    ...
    const validateDocumentToSave = (e) => {
        ...
        formData.append("carrier_id", props.selectedCarrier.id);
    ...
    return (
        <div className="panel-content">
            ...
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'carrier-info-documents')}><span className="fas fa-times"></span></div>
            ...
            <div className="documents-preview">
                <div className="form-bordered-box">
...

                    {
                        ...
                        <iframe id="frame-preview" src={(props.serverUrl + '/carrier-documents/' + props.selectedDocument.doc_id) + '#toolbar=1&navpanes=0&scrollbar=0'} frameBorder={0} allowFullScreen={true} width="100%" height="100%"></iframe>
                    }
...

                    {
                        ...
                        <iframe id="frame-preview" src={('https://view.officeapps.live.com/op/embed.aspx?src=' + props.serverUrl + '/carrier-documents/' + props.selectedDocument.doc_id) + '#toolbar=1&navpanes=0&scrollbar=0'} frameBorder={0} allowFullScreen={true} width="100%" height="100%"></iframe>
                    }

                    {
                        ...
                        // <div className="img-wrapper"><img src={props.serverUrl + '/carrier-documents/' + props.selectedDocument.doc_id} alt="" /></div>
                        <iframe id="frame-preview" src={(props.serverUrl + '/carrier-documents/' + props.selectedDocument.doc_id) + '#toolbar=1&navpanes=0&scrollbar=0'} frameBorder={0} allowFullScreen={true} width="100%" height="100%"></iframe>
                    }

                    {
                        ...
                        <div className="preview-not-available">
                            <span>No preview available for this file</span> <a href={props.serverUrl + '/carrier-documents/' + props.selectedDocument.doc_id} download={true}>Download</a>
                        </div>
                    }
                </div>
            </div>
...
const mapStateToProps = state => {
    return {
        ...
        documentTags: state.carrierReducers.documentTags,
        selectedDocumentNote: state.carrierReducers.selectedDocumentNote
    }
}
