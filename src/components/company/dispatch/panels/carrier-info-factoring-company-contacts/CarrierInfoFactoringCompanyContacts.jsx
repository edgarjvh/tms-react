...
function CarrierInfoFactoringCompanyContacts(props) {
    ...
    const borderBottomClasses = classnames({
        ...
        'disabled': !props.dispatchCarrierInfoFactoringCompanyIsEditingContact
    });
    ...
    const saveFactoringCompanyContact = () => {
        ...
        $.post(props.serverUrl + '/saveFactoringCompanyContact', contact).then(async res => {
            if (res.result === 'OK') {
                if (props.selectedDispatchCarrierInfoFactoringCompany.id !== undefined) {
                ...
                await props.setSelectedDispatchCarrierInfoFactoringCompanyContactSearch({ ...props.factoringCompany, selectedContact: res.contact, contacts: res.contacts });

                props.setDispatchCarrierInfoFactoringCompanyIsEditingContact(false);
            }
        });
    }
        ...
        if (window.confirm('Are you sure to delete this contact?')) {
            $.post(props.serverUrl + '/deleteFactoringCompanyContact', contact).then(async res => {
                if (res.result === 'OK') {
                    ...
                    if (props.selectedContact.id !== undefined) {
                        if (props.selectedContact.id === contact.id) {
                            await props.setSelectedDispatchCarrierInfoFactoringCompanyContact({});
                        }
                    }

                    await props.setSelectedDispatchCarrierInfoFactoringCompanyContactSearch({ ...props.factoringCompany, selectedContact: {}, contacts: res.contacts });
    ...
    return (
        <div className="panel-content">
            ...
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'carrier-info-factoring-company-contacts')}><span className="fas fa-times"></span></div>
                                        ...
                                        return (
                                            <div key={index}>
                                                ...
                                                <div className="row-contact" onClick={async () => {
                                                    await props.setSelectedDispatchCarrierInfoFactoringCompanyContactSearch({ ...props.factoringCompany, selectedContact: contact });
                                                    props.setDispatchCarrierInfoFactoringCompanyIsEditingContact(false);
                                                }}>
                ...
                <div className="contact-form">
                    <div className="contact-form-header">
                        <div className="contact-avatar-container">
                            ...
                            {
                                (props.dispatchCarrierInfoFactoringCompanyIsEditingContact && (props.factoringCompany.selectedContact?.id || 0) > 0 && (props.factoringCompany.selectedContact?.avatar || '') !== '') && <span className="fas fa-trash-alt remove-contact-avatar-btn" onClick={removeContactAvatar}></span>
                            }
                            {
                                (props.dispatchCarrierInfoFactoringCompanyIsEditingContact && (props.factoringCompany.selectedContact?.id || 0) > 0) && <span className="fas fa-sync change-contact-avatar-btn" onClick={() => { refInputAvatar.current.click() }}></span>
                            }
                            ...
                            <div className="input-toggle-container">
                                <input type="checkbox" id="cbox-panel-carrier-info-factoring-company-contacts-primary-btn"
                                    onChange={e => {
                                        ...
                                        props.setSelectedDispatchCarrierInfoFactoringCompanyContactSearch({ ...props.factoringCompany, selectedContact: contact });
                                    }}
                                    disabled={!props.dispatchCarrierInfoFactoringCompanyIsEditingContact}
                    ...
                    <div className="contact-form-fields">
                        <div className="contact-form-wrapper">
                            <div className="field-container">
                                ...
                                <input ref={refPrefix} type="text" readOnly={!props.dispatchCarrierInfoFactoringCompanyIsEditingContact}
                                    onChange={e => {
                                        let contact = props.factoringCompany.selectedContact;
                            ...
                            <div className="field-container">
                                ...
                                <input type="text" readOnly={!props.dispatchCarrierInfoFactoringCompanyIsEditingContact}
                                    onChange={e => {
                                        let contact = props.factoringCompany.selectedContact;
                            ...
                            <div className="field-container">
                                ...
                                <MaskedInput
                                    ...
                                    guide={true}
                                    type="text" readOnly={!props.dispatchCarrierInfoFactoringCompanyIsEditingContact}
                                    onChange={e => {
                                        let contact = props.factoringCompany.selectedContact;
                ...
                <div className="footer">
                    <div className="left-buttons">
                        <div className="mochi-button" onClick={() => {
                            props.setSelectedDispatchCarrierInfoFactoringCompanyContactSearch({ ...props.factoringCompany, selectedContact: { id: 0, carrier_id: props.factoringCompany.id } });
                    ...
                    <div className="right-buttons">
                        {
                            props.dispatchCarrierInfoFactoringCompanyIsEditingContact &&
                            <span className="fas fa-save" onClick={saveFactoringCompanyContact}></span>
                        }
                        {
                            !props.dispatchCarrierInfoFactoringCompanyIsEditingContact &&
                            <span className="fas fa-pencil-alt" onClick={() => { props.setDispatchCarrierInfoFactoringCompanyIsEditingContact(true) }} style={{
...
const mapStateToProps = state => {
    return {
        ...
        factoringCompany: state.carrierReducers.selectedDispatchCarrierInfoFactoringCompanyContactSearch,
