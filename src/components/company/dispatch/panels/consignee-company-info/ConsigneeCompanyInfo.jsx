                            ...
                            <div className="form-bordered-box">
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, name: e.target.value })} value={props.selectedConsigneeCompanyInfo.name || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Address 1" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, address1: e.target.value })} value={props.selectedConsigneeCompanyInfo.address1 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Address 2" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, address2: e.target.value })} value={props.selectedConsigneeCompanyInfo.address2 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="City" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, city: e.target.value })} value={props.selectedConsigneeCompanyInfo.city || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-state">
                                        <input type="text" readOnly={true} placeholder="State" maxLength="2" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, state: e.target.value })} value={props.selectedConsigneeCompanyInfo.state || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-zip-code">
                                        <input type="text" readOnly={true} placeholder="Postal Code" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, zip: e.target.value })} value={props.selectedConsigneeCompanyInfo.zip || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Contact Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, contact_name: e.target.value })} value={props.selectedConsigneeCompanyInfo.contact_name || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    ...
                                    <div className="input-box-container input-phone-ext">
                                        <input type="text" readOnly={true} placeholder="Ext" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, ext: e.target.value })} value={props.selectedConsigneeCompanyInfo.ext || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="E-Mail" style={{ textTransform: 'lowercase' }} onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, email: e.target.value })} value={props.selectedConsigneeCompanyInfo.email || ''} />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="fields-container-col" style={{ display: 'flex' }}>
                            <div className="form-bordered-box">
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_name: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_name || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Address 1" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_address1: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_address1 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Address 2" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_address2: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_address2 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="City" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_city: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_city || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-state">
                                        <input type="text" readOnly={true} placeholder="State" maxLength="2" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_state: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_state || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-zip-code">
                                        <input type="text" readOnly={true} placeholder="Postal Code" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_zip: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_zip || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Contact Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_contact_name: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_contact_name || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-phone">
                                        <MaskedInput
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-phone-ext">
                                        <input type="text" readOnly={true} placeholder="Ext" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_ext: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_ext || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="E-Mail" onKeyDown={validateCustomerForSaving} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_email: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_email || ''} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="form-borderless-box" style={{ width: '170px', marginLeft: '10px', }}>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} style={{ textTransform: 'uppercase' }} placeholder="Bill To" readOnly={true} onChange={e => props.setSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_bill_to: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_bill_to || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                    ...
                    <div className="fields-container-row">
                        <div className="fields-container-col">
                            <div className="form-bordered-box">
                                ...
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        ...
                                        <input type="text" readOnly={true} placeholder="First Name" onKeyDown={validateContactForSaving} onChange={e => {
                                            ...
                                            props.setSelectedContact({ ...props.selectedConsigneeCompanyContact, first_name: e.target.value })
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Last Name" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedContact({ ...props.selectedConsigneeCompanyContact, last_name: e.target.value })} value={props.selectedConsigneeCompanyContact.last_name || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container" style={{ width: '50%' }}>
                                        <MaskedInput
                                            mask={[/[0-9]/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]}
                                            guide={true}
                                            type="text" placeholder="Phone" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedContact({ ...props.selectedConsigneeCompanyContact, phone_work: e.target.value })} value={props.selectedConsigneeCompanyContact.phone_work || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div style={{ width: '50%', display: 'flex', justifyContent: 'space-between' }}>
                                        <div className="input-box-container input-phone-ext">
                                            <input type="text" readOnly={true} placeholder="Ext" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedContact({ ...props.selectedConsigneeCompanyContact, phone_ext: e.target.value })} value={props.selectedConsigneeCompanyContact.phone_ext || ''} />
                                        </div>
                                        <div className="input-toggle-container">
                                            <input type="checkbox" readOnly={true} id="cbox-customer-contacts-primary-btn" checked={(props.selectedConsigneeCompanyContact.is_primary || 0) === 1} />
                                ...
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="E-Mail" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedContact({ ...props.selectedConsigneeCompanyContact, email_work: e.target.value })} value={props.selectedConsigneeCompanyContact.email_work || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container grow">
                                        <input type="text" readOnly={true} placeholder="Notes" onKeyDown={validateContactForSaving} onChange={e => props.setSelectedContact({ ...props.selectedConsigneeCompanyContact, notes: e.target.value })} value={props.selectedConsigneeCompanyContact.notes || ''} />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="fields-container-col">
                            <div className="form-bordered-box">
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-toggle-container">
                                        <input type="checkbox" readOnly={true} id="cbox-automatic-emails-booked-load-btn" checked={(props.selectedConsigneeCompanyInfo.automatic_emails?.automatic_emails_booked_load || 0) === 1} />
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-toggle-container">
                                        <input type="checkbox" readOnly={true} id="cbox-automatic-emails-check-calls-btn" checked={(props.selectedConsigneeCompanyInfo.automatic_emails?.automatic_emails_check_calls || 0) === 1} />
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-toggle-container">
                                        <input type="checkbox" readOnly={true} id="cbox-automatic-emails-carrier-arrival-shipper-btn" checked={(props.selectedConsigneeCompanyInfo.automatic_emails?.automatic_emails_carrier_arrival_shipper || 0) === 1} />
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-toggle-container">
                                        <input type="checkbox" readOnly={true} id="cbox-automatic-emails-carrier-arrival-consignee-btn" checked={(props.selectedConsigneeCompanyInfo.automatic_emails?.automatic_emails_carrier_arrival_consignee || 0) === 1} />
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-toggle-container">
                                        <input type="checkbox" readOnly={true} id="cbox-automatic-emails-loaded-btn" checked={(props.selectedConsigneeCompanyInfo.automatic_emails?.automatic_emails_loaded || 0) === 1} />
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-toggle-container">
                                        <input type="checkbox" readOnly={true} id="cbox-automatic-emails-empty-btn" checked={(props.selectedConsigneeCompanyInfo.automatic_emails?.automatic_emails_empty || 0) === 1} />
                                                    ...
                                                    (props.selectedConsigneeCompanyInfo.contacts || []).map((contact, index) => {
                                                        return (
                                                            <div className="contact-list-item" key={index} onDoubleClick={async () => {
                                                                ...
                                                                await props.setContactSearchCustomer({ ...props.selectedConsigneeCompanyInfo, selectedContact: contact });
