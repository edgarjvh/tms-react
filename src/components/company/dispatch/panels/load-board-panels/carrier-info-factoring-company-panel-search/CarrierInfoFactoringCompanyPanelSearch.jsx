...
function CarrierInfoFactoringCompanyPanelSearch(props) {
        ...
        window.setTimeout(() => {
            if (clickCount === 1) {       
                ...
                // }
                 ...
                 props.setLbCarrierInfoFactoringCompanySearch([]);  

                closePanelBtnClick(null, 'lb-carrier-info-factoring-company-panel-search');
            }
    ...
    return (
        <div className="panel-content">
            ...
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'lb-carrier-info-factoring-company-panel-search')}><span className="fas fa-times"></span></div>
