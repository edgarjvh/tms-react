...
function Routing(props) {
        ...
        switch (popupActiveInput) {
            case 'equipment':
                await props.setSelectedLbCarrierInfoDriver({
                    ...props.selectedLbCarrierInfoDriver,
                    equipment: item,
                    equipment_id: item.id,
                    carrier_id: props.selectedLbCarrierInfoCarrier.id || 0
                });

                if ((props.selectedLbCarrierInfoCarrier?.id || 0) > 0) {
                    let driver = {
                        ...props.selectedLbCarrierInfoDriver,
                        id: (props.selectedLbCarrierInfoDriver?.id || 0),
                        carrier_id: props.selectedLbCarrierInfoCarrier.id || 0,
                        equipment: item,
                        equipment_id: item.id
                    };
                        ...
                        if (!isSavingCarrierDriver) {
                            ...
                            $.post(props.serverUrl + '/saveCarrierDriver', driver).then(async res => {
                                if (res.result === 'OK') {
                                    ...
                                    await props.setSelectedLbCarrierInfoDriver({ ...driver, id: res.driver.id });
                                }
                ...
                break;
            case 'driver-name':
                await props.setSelectedLbCarrierInfoDriver(item);
        ...
        if (keyCode === 9) {
            if (e.target.value.trim() !== '') {
                ...
                if ((props.selected_order?.id || 0) === 0) {
                    ...
                    props.setSelectedLbCarrierInfoCarrier({});
                ...
                $.post(props.serverUrl + '/carriers', {
                    ...
                    if (res.result === 'OK') {
                        if (res.carriers.length > 0) {
                            ...
                            props.setSelectedLbCarrierInfoCarrier(res.carriers[0]);
                            ...
                            if (res.carriers[0].drivers.length > 0) {
                                props.setSelectedLbCarrierInfoDriver(res.carriers[0].drivers[0]);
    ...
    const validateCarrierInfoForSaving = (e) => {
        ...
        if (keyCode === 9) {
            ...
            window.setTimeout(() => {
                let selectedLbCarrierInfoCarrier = props.selectedLbCarrierInfoCarrier;

                if (selectedLbCarrierInfoCarrier.id === undefined || selectedLbCarrierInfoCarrier.id === -1) {
                    selectedLbCarrierInfoCarrier.id = 0;
                }

                if (
                    (selectedLbCarrierInfoCarrier.name || '').trim().replace(/\s/g, "").replace("&", "A") !== "" &&
                    (selectedLbCarrierInfoCarrier.city || '').trim().replace(/\s/g, "") !== "" &&
                    (selectedLbCarrierInfoCarrier.state || '').trim().replace(/\s/g, "") !== "" &&
                    (selectedLbCarrierInfoCarrier.address1 || '').trim() !== "" &&
                    (selectedLbCarrierInfoCarrier.zip || '').trim() !== ""
                ) {
                    let parseCity = selectedLbCarrierInfoCarrier.city.trim().replace(/\s/g, "").substring(0, 3);
                    ...
                    let newCode = (selectedLbCarrierInfoCarrier.name || '').trim().replace(/\s/g, "").replace("&", "A").substring(0, 3) + parseCity.substring(0, 2) + (selectedLbCarrierInfoCarrier.state || '').trim().replace(/\s/g, "").substring(0, 2);

                    selectedLbCarrierInfoCarrier.code = newCode.toUpperCase();

                    if (!isSavingCarrierInfo) {
                        setIsSavingCarrierInfo(true);

                        $.post(props.serverUrl + '/saveCarrier', selectedLbCarrierInfoCarrier).then(async res => {
                            if (res.result === 'OK') {
                                if (props.selectedLbCarrierInfoCarrier.id === undefined && (props.selectedLbCarrierInfoCarrier.id || 0) === 0) {
                                    await props.setSelectedLbCarrierInfoCarrier({ ...props.selectedLbCarrierInfoCarrier, id: res.carrier.id });
                                }
    ...
    const validateCarrierContactForSaving = (e) => {
        ...
        if (keyCode === 9) {
            ...
            if ((props.selectedLbCarrierInfoContact.id || 0) === 0) {
                return;
            }
    ...
    const validateCarrierDriverForSaving = async (e) => {
        ...
        if (key === 9) {
            let driver = { ...props.selectedLbCarrierInfoDriver, id: (props.selectedLbCarrierInfoDriver?.id || 0), carrier_id: props.selectedLbCarrierInfoCarrier?.id };
    ...
    return (
        <div className="panel-content routing">
            ...
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'lb-routing')}><span className="fas fa-times"></span></div>
                ...
                <div style={{
                    ...
                    <div className='form-bordered-box' style={{
                        ...
                        <div className="form-row">
                            <div className="input-box-container input-code">
                                <input tabIndex={50 + props.tabTimes} type="text" placeholder="Code" maxLength="8"
                                    ...
                                    // onInput={(e) => { props.setSelectedLbCarrierInfoCarrier({ ...props.selectedLbCarrierInfoCarrier, code: e.target.value }) }}
                                    // onChange={(e) => { props.setSelectedLbCarrierInfoCarrier({ ...props.selectedLbCarrierInfoCarrier, code: e.target.value }) }}
                                    value={props.selectedLbCarrierInfoCarrier?.code || ''}
                                />
                            </div>
                            ...
                            <div className="input-box-container grow">
                                <input tabIndex={51 + props.tabTimes} type="text" placeholder="Name"
                                    ...
                                    // onInput={(e) => { props.setSelectedLbCarrierInfoCarrier({ ...props.selectedLbCarrierInfoCarrier, name: e.target.value }) }}
                                    // onChange={(e) => { props.setSelectedLbCarrierInfoCarrier({ ...props.selectedLbCarrierInfoCarrier, name: e.target.value }) }}
                        ...
                        <div className="form-row">
                            <div className="input-box-container grow">
                                ...
                                readOnly={true}
                                    ...
                                    //     props.setSelectedLbCarrierInfoContact({ ...props.selectedLbCarrierInfoContact, first_name: first_name, last_name: last_name });
                                    // }}
                            ...
                            <div className="input-box-container grow">
                                <MaskedInput tabIndex={54 + props.tabTimes}
                                    ...
                                    readOnly={true}
                                    // onKeyDown={validateCarrierContactForSaving}
                                    // onInput={(e) => { props.setSelectedLbCarrierInfoContact({ ...props.selectedLbCarrierInfoContact, phone_work: e.target.value }) }}
                                    // onChange={(e) => { props.setSelectedLbCarrierInfoContact({ ...props.selectedLbCarrierInfoContact, phone_work: e.target.value }) }}
                        ...
                        <div className="form-row">
                            <div className="input-box-container grow" style={{ position: 'relative' }}>
                                <input tabIndex={57 + props.tabTimes} type="text" placeholder="Driver Name"
                                    ...
                                    // onChange={(e) => {
                                    //     let driver = props.selectedLbCarrierInfoDriver || {};
                                    ...
                                    //         props.setSelectedLbCarrierInfoDriver({ ...driver, first_name: first_name, last_name: last_name });
                                    //     }
                                    // }}
                                ...
                                />
                                {/* {
                                    (props.selectedLbCarrierInfoCarrier?.drivers || []).length > 1 &&
                                    <span className="fas fa-caret-down" style={{
                                        position: 'absolute',
                                        right: 5,
                                        top: 'calc(50% + 2px)',
                                        ...
                                        delayTimer = window.setTimeout(async () => {
                                            ...
                                            items = props.selectedLbCarrierInfoCarrier.drivers.map((driver, i) => {
                                                if (((driver.first_name || '') + ((driver.last_name || '').trim() === '' ? '' : ' ' + driver.last_name))
                                                    === ((props.selectedLbCarrierInfoDriver?.first_name || '') + ((props.selectedLbCarrierInfoDriver?.last_name || '').trim() === '' ? '' : ' ' + props.selectedLbCarrierInfoDriver?.last_name))) {
                            ...
                            <div className="input-box-container grow">
                                <MaskedInput tabIndex={58 + props.tabTimes}
                                    ...
                                    readOnly={true}
                                    // onKeyDown={validateCarrierDriverForSaving}
                                    // onInput={(e) => { props.setSelectedLbCarrierInfoDriver({ ...props.selectedLbCarrierInfoDriver, phone: e.target.value }) }}
                                    // onChange={(e) => { props.setSelectedLbCarrierInfoDriver({ ...props.selectedLbCarrierInfoDriver, phone: e.target.value }) }}
                        ...
                        <div className="form-row" style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', flexGrow: 1, alignItems: 'flex-start', marginTop: 10 }}>
                            <div className='mochi-button' onClick={() => {
                                if (!props.dispatchOpenedPanels.includes('lb-rate-conf')) {
                                    props.setDispatchOpenedPanels([...props.dispatchOpenedPanels, 'lb-rate-conf'])
                                }
                            }}>
                                <div className='mochi-button-decorator mochi-button-decorator-left'>(</div>
...
const mapStateToProps = state => {
    return {
        ...
        order_number: state.dispatchReducers.lb_order_number,
        trip_number: state.dispatchReducers.lb_trip_number,
        mileageLoaderVisible: state.dispatchReducers.lbMileageLoaderVisible,
