...
function ConsigneeCompanyDocuments(props) {
    ...
    const tagsOnKeydown = (e) => {
        ...
        if (keyCode === 13) {
            props.setLbSelectedConsigneeCompanyDocument({ ...props.selectedConsigneeCompanyDocument, tags: (props.selectedConsigneeCompanyDocument.tags || '') === '' ? props.consigneeCompanyDocumentTags : props.selectedConsigneeCompanyDocument.tags + '|' + props.consigneeCompanyDocumentTags });
            props.setLbConsigneeCompanyDocumentTags('');
    ...
    const validateDocumentToSave = (e) => {
        ...
        $.ajax({
            ...
            success: (res) => {
                console.log(res);
                if (res.result === "OK") {
                    props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, documents: res.documents });
    ...
    const quickTypeLinkClasses = classnames({
        ...
        'disabled': (props.selectedConsigneeCompanyDocument.id || 0) > 0
    });

    return (
        <div className="panel-content">
            <div className="drag-handler" onClick={e => e.stopPropagation()}></div>
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'lb-consignee-company-documents')}><span className="fas fa-times"></span></div>
                    ...
                    <div className="documents-fields-row">
                        ...
                        <div className="input-box-container">
                            <input
                                ...
                                onChange={(e) => { props.setLbSelectedConsigneeCompanyDocument({ ...props.selectedConsigneeCompanyDocument, title: e.target.value }) }}
                        ...
                        <div className="input-box-container">
                            <input
                                ...
                                onChange={(e) => { props.setLbSelectedConsigneeCompanyDocument({ ...props.selectedConsigneeCompanyDocument, subject: e.target.value }) }}
                                readOnly={(props.selectedConsigneeCompanyDocument.id || 0) > 0} />
                        </div>
                        ...
                        <div className="input-box-container tags" style={{
                                            ...
                                            <div key={index} style={{
                                            ...
                                            }} title={item}>
                                                {
                                                    ...
                                                    <span className="fas fa-trash-alt" style={{ marginRight: '5px', cursor: 'pointer' }}
                                                        onClick={() => {
                                                            props.setLbSelectedConsigneeCompanyDocument({ ...props.selectedConsigneeCompanyDocument, tags: (props.selectedConsigneeCompanyDocument.tags || '').replace(item, '').trim() })
                                                        }}></span>
                                                }
                            ...
                            <input type="text" placeholder="Tags" ref={refTagInput}
                                ...
                                onChange={(e) => { props.setLbConsigneeCompanyDocumentTags(e.target.value) }}
                                onInput={(e) => { props.setLbConsigneeCompanyDocumentTags(e.target.value) }}
                                readOnly={(props.selectedConsigneeCompanyDocument.id || 0) > 0} />
                        </div>
                    </div>
                </div>
                            ...
                            (props.selectedConsigneeCompanyInfo.documents || []).map((document, index) => {
                                ...
                                return (
                                    <div className={itemClasses} key={index} onClick={() => {
                                        props.setLbSelectedConsigneeCompanyDocument(document);
                        ...
                        <div className="form-buttons">
                            <div className="mochi-button" onClick={() => {
                                if ((props.selectedConsigneeCompanyDocument.id || 0) > 0) {
                                    props.setLbSelectedConsigneeCompanyDocumentNote({ id: 0, customer_document_id: props.selectedConsigneeCompanyDocument.id })
                                } else {
                            ...
                            (props.selectedConsigneeCompanyDocument.notes || []).map((note, index) => {
                                return (
                                    <div className='documents-notes-list-item' key={index} onClick={() => {
                                        props.setLbSelectedConsigneeCompanyDocumentNote(note);
                                    }}>
                                        {note.text}
                                    </div>
                                )
...

            {
                ...
                <animated.div style={modalTransitionProps}>
                    <CustomerModal
                        ...
                        setSelectedData={props.setLbSelectedConsigneeCompanyDocumentNote}
                        selectedParent={props.selectedConsigneeCompanyDocument}
                        setSelectedParent={(notes) => {

                            props.setLbSelectedConsigneeCompanyDocument({ ...props.selectedConsigneeCompanyDocument, notes: notes });

                            props.setLbSelectedConsigneeCompanyInfo({...props.selectedConsigneeCompanyInfo, documents: props.selectedConsigneeCompanyInfo.documents.map((document, index) => {
