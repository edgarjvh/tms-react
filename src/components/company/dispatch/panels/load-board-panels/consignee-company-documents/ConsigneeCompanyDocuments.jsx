...
function ConsigneeCompanyDocuments(props) {
    ...
    const tagsOnKeydown = (e) => {
        ...
        if (keyCode === 32) {
            e.preventDefault();
            props.setLbSelectedConsigneeCompanyDocument({ ...props.selectedConsigneeCompanyDocument, tags: ((props.selectedConsigneeCompanyDocument.tags || '') + ' ' + props.consigneeCompanyDocumentTags).trim() });
