...
import {
    ...
    setLbConsigneeCompanyDocumentTags,
...
function ConsigneeCompanyInfo(props) {
    ...
    const setInitialValues = (clearCode = true) => {
        ...
        props.setLbSelectedConsigneeCompanyNote({});
        props.setLbSelectedConsigneeCompanyDirection({});
        props.setLbConsigneeCompanyContactSearch({});

        props.setLbConsigneeCompanyShowingContactList(true);
        props.setLbConsigneeCompanyAutomaticEmailsTo('');
        props.setLbConsigneeCompanyAutomaticEmailsCc('');
        props.setLbConsigneeCompanyAutomaticEmailsBcc('');
        props.setLbSelectedConsigneeCompanyInfo({ id: -1, code: clearCode ? '' : props.selectedConsigneeCompanyInfo.code });
        setPopupItems([]);
    }
                ...
                $.post(props.serverUrl + '/customers', {
                    ...
                    if (res.result === 'OK') {
                        if (res.customers.length > 0) {
                            ...
                            await props.setLbSelectedConsigneeCompanyInfo(res.customers[0]);

                            await res.customers[0].contacts.map(async c => {
                                if (c.is_primary === 1) {
                                    await props.setLbSelectedConsigneeCompanyContact(c);
                                }
                                return true;
                            });
    ...
    const searchCustomerBtnClick = () => {
        ...
        $.post(props.serverUrl + '/customerSearch', { search: customerSearch }).then(async res => {
            if (res.result === 'OK') {
                ...
                await props.setLbConsigneeCompanies(res.customers);
               
                if (!props.dispatchOpenedPanels.includes('lb-consignee-company-search')){
                    props.setDispatchOpenedPanels([...props.dispatchOpenedPanels, 'lb-consignee-company-search'])
                }
            }
        });
    }
    ...
    const searchContactBtnClick = () => {
        ...
        $.post(props.serverUrl + '/customerContactsSearch', { search: filters }).then(async res => {
            if (res.result === 'OK') {
                await props.setLbConsigneeCompanyContactSearch({ ...props.consigneeCompanyContactSearch, filters: filters });
                await props.setLbConsigneeCompanyContacts(res.contacts);

                if (!props.dispatchOpenedPanels.includes('lb-consignee-company-contact-search')){
                    props.setDispatchOpenedPanels([...props.dispatchOpenedPanels, 'lb-consignee-company-contact-search'])
                }
            }
        });
    }
    ...
    const revenueInformationBtnClick = () => {
        if (!props.dispatchOpenedPanels.includes('lb-consignee-company-revenue-information')){
            props.setDispatchOpenedPanels([...props.dispatchOpenedPanels, 'lb-consignee-company-revenue-information'])
        }
    }

    const orderHistoryBtnClick = () => {
        if (!props.dispatchOpenedPanels.includes('lb-consignee-company-order-history')){
            props.setDispatchOpenedPanels([...props.dispatchOpenedPanels, 'lb-consignee-company-order-history'])
        }
    }

    const laneHistoryBtnClick = () => {
        if (!props.dispatchOpenedPanels.includes('lb-consignee-company-lane-history')){
            props.setDispatchOpenedPanels([...props.dispatchOpenedPanels, 'lb-consignee-company-lane-history'])
        }
    }

    const documentsBtnClick = () => {
        if ((props.selectedConsigneeCompanyInfo.id || 0) > 0) {
            props.setLbSelectedConsigneeCompanyDocument({
                id: 0,
                user_id: Math.floor(Math.random() * (15 - 1)) + 1,
                date_entered: moment().format('MM/DD/YYYY')
            });

            if (!props.dispatchOpenedPanels.includes('lb-consignee-company-documents')){
                props.setDispatchOpenedPanels([...props.dispatchOpenedPanels, 'lb-consignee-company-documents'])
            }
        } else {
        ...
        if (keyCode === 9) {
            ...
            window.setTimeout(() => {
                ...
                if (selectedCustomer.id === undefined || selectedCustomer.id === -1) {
                    ...
                    props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, id: 0 });
                }
                        ...
                        $.post(props.serverUrl + '/saveCustomer', selectedCustomer).then(async res => {
                            if (res.result === 'OK') {
                                if (props.selectedConsigneeCompanyInfo.id === undefined || (props.selectedConsigneeCompanyInfo.id || 0) === 0) {
                                    await props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, id: res.customer.id });

                                    if (res.customer.contacts[0].is_primary === 1) {
                                        await props.setLbSelectedConsigneeCompanyContact(res.customer.contacts[0]);
                                    }
                                }
                            }
    ...
    const remitToAddressBtn = () => {
        ...
        props.setLbSelectedConsigneeCompanyInfo(customer);
    ...
    const selectedContactIsPrimaryChange = async (e) => {
        await props.setLbSelectedConsigneeCompanyContact({ ...props.selectedConsigneeCompanyContact, is_primary: e.target.checked ? 1 : 0 });
    ...
    const popupItemClick = async (item) => {
        ...
        await props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, automatic_emails: automaticEmails });
    ...
    const automaticEmailsOnInput = async (e, name) => {
        window.clearTimeout(delayTimer);
        name === 'to' && props.setLbConsigneeCompanyAutomaticEmailsTo(e.target.value);
        name === 'cc' && props.setLbConsigneeCompanyAutomaticEmailsCc(e.target.value);
        name === 'bcc' && props.setLbConsigneeCompanyAutomaticEmailsBcc(e.target.value);
    ...
    const validateHoursForSaving = (e, name) => {
        ...
        $.post(props.serverUrl + '/saveCustomerHours', hours).then(async res => {
            if (res.result === 'OK') {
                await props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, hours: res.customer_hours });
            }
        })
    }
    ...
    return (
        <div className="panel-content">
            ...
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'lb-consignee-company-info')}><span className="fas fa-times"></span></div>
                    ...
                    <div className="fields-container-row">
                        <div className="fields-container-col">
                            <div className="form-bordered-box">
                                ...
                                <div className="form-row">
                                    <div className="input-box-container input-code">
                                        <input tabIndex={1 + props.tabTimes} type="text" placeholder="Code" maxLength="8" id="txt-customer-code"
                                            ...
                                            onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, code: e.target.value })}
                                    ...
                                    <div className="input-box-container grow">
                                        <input tabIndex={2 + props.tabTimes} type="text" placeholder="Name"
                                            ...
                                            onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, name: e.target.value })}
                                ...
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={3 + props.tabTimes} type="text" placeholder="Address 1" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, address1: e.target.value })} value={props.selectedConsigneeCompanyInfo.address1 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={4 + props.tabTimes} type="text" placeholder="Address 2" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, address2: e.target.value })} value={props.selectedConsigneeCompanyInfo.address2 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={5 + props.tabTimes} type="text" placeholder="City" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, city: e.target.value })} value={props.selectedConsigneeCompanyInfo.city || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-state">
                                        <input tabIndex={6 + props.tabTimes} type="text" placeholder="State" maxLength="2" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, state: e.target.value })} value={props.selectedConsigneeCompanyInfo.state || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-zip-code">
                                        <input tabIndex={7 + props.tabTimes} type="text" placeholder="Postal Code" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, zip: e.target.value })} value={props.selectedConsigneeCompanyInfo.zip || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={8 + props.tabTimes} type="text" placeholder="Contact Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, contact_name: e.target.value })} value={props.selectedConsigneeCompanyInfo.contact_name || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-phone">
                                        <MaskedInput
                                            ...
                                            guide={true}
                                            type="text" placeholder="Contact Phone" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, contact_phone: e.target.value })} value={props.selectedConsigneeCompanyInfo.contact_phone || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-phone-ext">
                                        <input tabIndex={10 + props.tabTimes} type="text" placeholder="Ext" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, ext: e.target.value })} value={props.selectedConsigneeCompanyInfo.ext || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={11 + props.tabTimes} type="text" placeholder="E-Mail" style={{ textTransform: 'lowercase' }} onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, email: e.target.value })} value={props.selectedConsigneeCompanyInfo.email || ''} />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="fields-container-col" style={{ display: 'flex' }}>
                                ...
                                <div className="form-row">
                                    <div className="input-box-container input-code">
                                        <input tabIndex={12 + props.tabTimes} type="text" placeholder="Code" maxLength="8"
                                            onKeyDown={validateCustomerForSaving}
                                            onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_code: e.target.value })}
                                    ...
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container grow">
                                        <input tabIndex={13 + props.tabTimes} type="text" placeholder="Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_name: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_name || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={14 + props.tabTimes} type="text" placeholder="Address 1" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_address1: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_address1 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={15 + props.tabTimes} type="text" placeholder="Address 2" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_address2: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_address2 || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={16 + props.tabTimes} type="text" placeholder="City" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_city: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_city || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-state">
                                        <input tabIndex={17 + props.tabTimes} type="text" placeholder="State" maxLength="2" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_state: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_state || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-zip-code">
                                        <input tabIndex={18 + props.tabTimes} type="text" placeholder="Postal Code" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_zip: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_zip || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={19 + props.tabTimes} type="text" placeholder="Contact Name" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_contact_name: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_contact_name || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-phone">
                                        <MaskedInput tabIndex={20 + props.tabTimes}
                                            mask={[/[0-9]/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]}
                                            guide={true}
                                            type="text" placeholder="Contact Phone" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_contact_phone: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_contact_phone || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container input-phone-ext">
                                        <input tabIndex={21 + props.tabTimes} type="text" placeholder="Ext" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_ext: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_ext || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={22 + props.tabTimes} type="text" placeholder="E-Mail" onKeyDown={validateCustomerForSaving} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_email: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_email || ''} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="form-borderless-box" style={{ width: '170px', marginLeft: '10px', }}>
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={32 + props.tabTimes} type="text" style={{ textTransform: 'uppercase' }} placeholder="Bill To" readOnly={true} onChange={e => props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, mailing_bill_to: e.target.value })} value={props.selectedConsigneeCompanyInfo.mailing_bill_to || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                    ...
                    <div className="fields-container-row">
                        <div className="fields-container-col">
                            <div className="form-bordered-box">
                                <div className="form-header">
                                    ...
                                    <div className="form-buttons">
                                        <div className="mochi-button" onClick={async () => {
                                            ...
                                            await props.setLbConsigneeCompanyIsEditingContact(false);
                                            await props.setLbConsigneeCompanyContactSearchCustomer({ ...props.selectedConsigneeCompanyInfo, selectedConsigneeCompanyContact: props.selectedConsigneeCompanyContact });
                                        ...
                                        <div className="mochi-button" onClick={() => {
                                            ...
                                            props.setLbConsigneeCompanyContactSearchCustomer({ ...props.selectedConsigneeCompanyInfo, selectedConsigneeCompanyContact: { id: 0, customer_id: props.selectedConsigneeCompanyInfo.id } });
                                        ...
                                        <div className="mochi-button" onClick={() => props.setLbSelectedConsigneeCompanyContact({})}>
                                            <div className="mochi-button-decorator mochi-button-decorator-left">(</div>
                                            <div className="mochi-button-base">Clear</div>
                                            <div className="mochi-button-decorator mochi-button-decorator-right">)</div>
                                        </div>
                                ...
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={23 + props.tabTimes} type="text" placeholder="First Name" onKeyDown={validateContactForSaving} onChange={e => {
                                            ...
                                            props.setLbSelectedConsigneeCompanyContact({ ...props.selectedConsigneeCompanyContact, first_name: e.target.value })
                                        }} value={props.selectedConsigneeCompanyContact.first_name || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container grow">
                                        <input tabIndex={24 + props.tabTimes} type="text" placeholder="Last Name" onKeyDown={validateContactForSaving} onChange={e => props.setLbSelectedConsigneeCompanyContact({ ...props.selectedConsigneeCompanyContact, last_name: e.target.value })} value={props.selectedConsigneeCompanyContact.last_name || ''} />
                                    </div>
                                </div>
                                <div className="form-v-sep"></div>
                                <div className="form-row">
                                    <div className="input-box-container" style={{ width: '50%' }}>
                                        <MaskedInput tabIndex={25 + props.tabTimes}
                                            mask={[/[0-9]/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]}
                                            guide={true}
                                            type="text" placeholder="Phone" onKeyDown={validateContactForSaving} onChange={e => props.setLbSelectedConsigneeCompanyContact({ ...props.selectedConsigneeCompanyContact, phone_work: e.target.value })} value={props.selectedConsigneeCompanyContact.phone_work || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div style={{ width: '50%', display: 'flex', justifyContent: 'space-between' }}>
                                        <div className="input-box-container input-phone-ext">
                                            <input tabIndex={26 + props.tabTimes} type="text" placeholder="Ext" onKeyDown={validateContactForSaving} onChange={e => props.setLbSelectedConsigneeCompanyContact({ ...props.selectedConsigneeCompanyContact, phone_ext: e.target.value })} value={props.selectedConsigneeCompanyContact.phone_ext || ''} />
                                        </div>
                                ...
                                <div className="form-row">
                                    <div className="input-box-container grow">
                                        <input tabIndex={27 + props.tabTimes} type="text" placeholder="E-Mail" onKeyDown={validateContactForSaving} onChange={e => props.setLbSelectedConsigneeCompanyContact({ ...props.selectedConsigneeCompanyContact, email_work: e.target.value })} value={props.selectedConsigneeCompanyContact.email_work || ''} />
                                    </div>
                                    <div className="form-h-sep"></div>
                                    <div className="input-box-container grow">
                                        <input tabIndex={28 + props.tabTimes} type="text" placeholder="Notes" onKeyDown={validateContactForSaving} onChange={e => props.setLbSelectedConsigneeCompanyContact({ ...props.selectedConsigneeCompanyContact, notes: e.target.value })} value={props.selectedConsigneeCompanyContact.notes || ''} />
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div key={index} style={{
                                                            ...
                                                            <span className="fas fa-trash-alt" style={{ marginRight: '5px', cursor: 'pointer' }}
                                                                onClick={() => {
                                                                    ...
                                                                    props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, automatic_emails: automatic_emails });
                                    ...
                                    <div className="form-buttons">
                                        {
                                            ...
                                            <div className="mochi-button" onClick={() => props.setLbConsigneeCompanyShowingContactList(false)}>
                                                <div className="mochi-button-decorator mochi-button-decorator-left">(</div>
                                                <div className="mochi-button-base">Search</div>
                                                <div className="mochi-button-decorator mochi-button-decorator-right">)</div>
                                            </div>
                                        ...
                                        {
                                            !props.consigneeCompanyShowingContactList &&
                                            <div className="mochi-button" onClick={() => props.setLbConsigneeCompanyShowingContactList(true)}>
                                                <div className="mochi-button-decorator mochi-button-decorator-left">(</div>
                                ...
                                <div className="form-slider">
                                    <div className="form-slider-wrapper" style={{ left: props.consigneeCompanyShowingContactList ? 0 : '-100%' }}>
                                                    ...
                                                    (props.selectedConsigneeCompanyInfo.contacts || []).map((contact, index) => {
                                                        return (
                                                            <div className="contact-list-item" key={index} onDoubleClick={async () => {
                                                                ...
                                                                await props.setLbConsigneeCompanyIsEditingContact(false);
                                                                await props.setLbConsigneeCompanyContactSearchCustomer({ ...props.selectedConsigneeCompanyInfo, selectedConsigneeCompanyContact: contact });

                                                                if (!props.dispatchOpenedPanels.includes('lb-consignee-company-contacts')){
                                                                    props.setDispatchOpenedPanels([...props.dispatchOpenedPanels, 'lb-consignee-company-contacts'])
                                                                }
                                                            }} onClick={() => props.setLbSelectedConsigneeCompanyContact(contact)}>
                                        ...
                                        <div className="contact-search-box">
                                            <div className="form-row">
                                                <div className="input-box-container grow">
                                                    <input type="text" placeholder="First Name" onChange={e => props.setLbConsigneeCompanyContactSearch({ ...props.consigneeCompanyContactSearch, first_name: e.target.value })} value={props.consigneeCompanyContactSearch.first_name || ''} />
                                                </div>
                                                <div className="form-h-sep"></div>
                                                <div className="input-box-container grow">
                                                    <input type="text" placeholder="Last Name" onFocus={() => { props.setLbConsigneeCompanyShowingContactList(false) }} onChange={e => props.setLbConsigneeCompanyContactSearch({ ...props.consigneeCompanyContactSearch, last_name: e.target.value })} value={props.consigneeCompanyContactSearch.last_name || ''} />
                                                </div>
                                            </div>
                                            <div className="form-v-sep"></div>
                                            <div className="form-row">
                                                <div className="input-box-container grow">
                                                    <input type="text" placeholder="Address 1" onFocus={() => { props.setLbConsigneeCompanyShowingContactList(false) }} onChange={e => props.setLbConsigneeCompanyContactSearch({ ...props.consigneeCompanyContactSearch, address1: e.target.value })} value={props.consigneeCompanyContactSearch.address1 || ''} />
                                                </div>
                                            </div>
                                            <div className="form-v-sep"></div>
                                            <div className="form-row">
                                                <div className="input-box-container grow">
                                                    <input type="text" placeholder="Address 2" onFocus={() => { props.setLbConsigneeCompanyShowingContactList(false) }} onChange={e => props.setLbConsigneeCompanyContactSearch({ ...props.consigneeCompanyContactSearch, address2: e.target.value })} value={props.consigneeCompanyContactSearch.address2 || ''} />
                                                </div>
                                            </div>
                                            <div className="form-v-sep"></div>
                                            <div className="form-row">
                                                <div className="input-box-container grow">
                                                    <input type="text" placeholder="City" onFocus={() => { props.setLbConsigneeCompanyShowingContactList(false) }} onChange={e => props.setLbConsigneeCompanyContactSearch({ ...props.consigneeCompanyContactSearch, city: e.target.value })} value={props.consigneeCompanyContactSearch.city || ''} />
                                                </div>
                                                <div className="form-h-sep"></div>
                                                <div className="input-box-container input-state">
                                                    <input type="text" placeholder="State" maxLength="2" onFocus={() => { props.setLbConsigneeCompanyShowingContactList(false) }} onChange={e => props.setLbConsigneeCompanyContactSearch({ ...props.consigneeCompanyContactSearch, state: e.target.value })} value={props.consigneeCompanyContactSearch.state || ''} />
                                                </div>
                                                <div className="form-h-sep"></div>
                                                <div className="input-box-container grow">
                                                    <MaskedInput
                                                        mask={[/[0-9]/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]}
                                                        guide={true}
                                                        type="text" placeholder="Phone (Work/Mobile/Fax)" onFocus={() => { props.setLbConsigneeCompanyShowingContactList(false) }} onChange={e => props.setLbConsigneeCompanyContactSearch({ ...props.consigneeCompanyContactSearch, phone: e.target.value })} value={props.consigneeCompanyContactSearch.phone || ''} />
                                                </div>
                                            </div>
                                            <div className="form-v-sep"></div>
                                            <div className="form-row">
                                                <div className="input-box-container grow">
                                                    <input type="text" placeholder="E-Mail" style={{ textTransform: 'lowercase' }}
                                                        ...
                                                        onFocus={() => { props.setLbConsigneeCompanyShowingContactList(false) }}
                                                        onChange={e => props.setLbConsigneeCompanyContactSearch({ ...props.consigneeCompanyContactSearch, email: e.target.value })}
                                        ...
                                        <div className="input-box-container ">
                                            <input tabIndex={39 + props.tabTimes} type="text" placeholder="Open"
                                                ...
                                                onChange={e => {
                                                    ...
                                                    props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, hours: hours });
                                                }}
                        ...
                        <div className="fields-container-col">
                            <div className="form-bordered-box" >
                                <div className="form-header">
                                    ...
                                    <div className="top-border top-border-middle"></div>
                                    <div className="form-buttons">
                                        <div className="mochi-button" onClick={() => props.setLbSelectedConsigneeCompanyNote({ id: 0, customer_id: props.selectedConsigneeCompanyInfo.id })}>
                                            <div className="mochi-button-decorator mochi-button-decorator-left">(</div>
                                    ...
                                    <div className="notes-list-wrapper">
                                        {
                                            (props.selectedConsigneeCompanyInfo.notes || []).map((note, index) => {
                                                return (
                                                    <div className="notes-list-item" key={index} onClick={() => props.setLbSelectedConsigneeCompanyNote(note)}>
                                                        {note.text}
                                                    </div>
                                                )
                                            })
                        ...
                        <div className="fields-container-col">
                            <div className="form-bordered-box" >
                                <div className="form-header">
                                    ...
                                    <div className="top-border top-border-middle"></div>
                                    <div className="form-buttons">
                                        <div className="mochi-button" onClick={() => props.setLbSelectedConsigneeCompanyDirection({ id: 0, customer_id: props.selectedConsigneeCompanyInfo.id })}>
                                            <div className="mochi-button-decorator mochi-button-decorator-left">(</div>
                                    ...
                                    <div className="directions-list-wrapper">
                                        {
                                            (props.selectedConsigneeCompanyInfo.directions || []).map((direction, index) => {
                                                return (
                                                    <div className="directions-list-item" key={index} onClick={() => props.setLbSelectedConsigneeCompanyDirection(direction)}>
                                                        {direction.text}
                                                    </div>
                                                )
                                            })
...

            {
                ...
                <animated.div style={modalTransitionProps}>
                    <CustomerModal
                        ...
                        setSelectedData={props.setLbSelectedConsigneeCompanyNote}
                        selectedParent={props.selectedConsigneeCompanyInfo}
                        setSelectedParent={(notes) => {
                            props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, notes: notes });
                        }}
...

            {
                ...
                <animated.div style={modalTransitionProps}>
                    <CustomerModal
                        ...
                        setSelectedData={props.setLbSelectedConsigneeCompanyDirection}
                        selectedParent={props.selectedConsigneeCompanyInfo}
                        setSelectedParent={(directions) => {
                            props.setLbSelectedConsigneeCompanyInfo({ ...props.selectedConsigneeCompanyInfo, directions: directions });
                        }}
...
const mapStateToProps = state => {
    return {
        ...
        consigneeCompanySearch: state.customerReducers.lbConsigneeCompanySearch,
        selectedConsigneeCompanyNote: state.customerReducers.selectedLbConsigneeCompanyNote,
        selectedConsigneeCompanyDirection: state.customerReducers.selectedLbConsigneeCompanyDirection,
        consigneeCompanyContactSearch: state.customerReducers.lbConsigneeCompanyContactSearch,
        consigneeCompanyAutomaticEmailsTo: state.customerReducers.lbConsigneeCompanyAutomaticEmailsTo,
        consigneeCompanyAutomaticEmailsCc: state.customerReducers.lbConsigneeCompanyAutomaticEmailsCc,
        consigneeCompanyAutomaticEmailsBcc: state.customerReducers.lbConsigneeCompanyAutomaticEmailsBcc,
        consigneeCompanyShowingContactList: state.customerReducers.lbConsigneeCompanyShowingContactList,
        ...
        selectedConsigneeCompanyDocument: state.customerReducers.selectedLbConsigneeCompanyDocument,
        consigneeCompanyDocumentTags: state.customerReducers.lbConsigneeCompanyDocumentTags,
        selectedConsigneeCompanyDocumentNote: state.customerReducers.selectedLbConsigneeCompanyDocumentNote
    }
}
