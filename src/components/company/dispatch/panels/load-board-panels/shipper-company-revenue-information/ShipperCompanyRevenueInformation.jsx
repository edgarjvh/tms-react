...
function ShipperCompanyRevenueInformation(props) {
    ...
    return (
        <div className="panel-content">
            ...
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'lb-shipper-company-revenue-information')}><span className="fas fa-times"></span></div>
                ...
                <div className="row-fields">
                    <div className="input-box-container date">
                        ...
                        <span className="fas fa-calendar-alt open-calendar-btn" onClick={(e) => {
                            ...
                            const panelGap = 70;
                            const panelWidth = (window.innerWidth * baseWidth) - (panelGap * props.dispatchOpenedPanels.indexOf('shipper-company-revenue-information'));
