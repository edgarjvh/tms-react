...
import './CarrierInfoEquipmentInformation.css';
...
function CarrierInfoEquipmentInformation(props) {
    var delayTimer;
    ...
    const closePanelBtnClick = (e, name) => {
        props.setLbCarrierInfoEquipmentInformation({});
    ...
    const popupItemClick = async (item) => {
        switch (popupActiveInput) {
            case 'equipment':
                props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, equipment: item, equipment_id: item.id });
                await setPopupItems([]);
                break;
            default:
                break;
        ...
        if (key === 13) {
            popupItems.map((item, index) => {
                if (item.selected) {
                    ...
                    props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, equipment: item });
    ...
    const onEquipmentInput = async (e) => {
        ...
        let equipment = props.lbCarrierInfoEquipmentInformation.equipment || {};
        equipment.name = e.target.value.trim();
        await props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, equipment_id: 0, equipment: equipment });
    ...
    return (
        <div className="panel-content">
            ...
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'lb-carrier-info-equipment-information')}><span className="fas fa-times"></span></div>
                ...
                <div className="form-row">
                    <div className="input-box-container input-code">
                        <input type="text" maxLength="8" placeholder="Code"
                            onInput={(e) => { props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, code: e.target.value }) }}
                            onChange={(e) => { props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, code: e.target.value }) }}
                            value={props.lbCarrierInfoEquipmentInformation.code || ''}
                        />
                    </div>
                    <div className="form-h-sep"></div>
                    <div className="input-box-container grow">
                        <input type="text" placeholder="Name"
                            onInput={(e) => { props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, name: e.target.value }) }}
                            onChange={(e) => { props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, name: e.target.value }) }}
                            value={props.lbCarrierInfoEquipmentInformation.name || ''}
                        />
                    </div>
                </div>
                ...
                <div className="form-row">
                    <div className="input-box-container grow" style={{ position: 'relative' }}>
                        <input type="text" placeholder="Equipment"
                            ...
                            value={props.lbCarrierInfoEquipmentInformation.equipment?.name || ''}
                        />
                    ...
                    <div className="input-box-container" style={{ width: '10rem' }}>
                        <input type="text" placeholder="Number of Units"
                            onInput={(e) => { props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, units: e.target.value }) }}
                            onChange={(e) => { props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, units: e.target.value }) }}
                            value={props.lbCarrierInfoEquipmentInformation.units || ''}
                        />
                    </div>
                </div>
                <div className="form-v-sep"></div>
                <div className="form-row">
                    <div className="input-box-container grow">
                        <input type="text" placeholder="Length"
                            onInput={(e) => { props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, equipment_length: e.target.value }) }}
                            onChange={(e) => { props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, equipment_length: e.target.value }) }}
                            value={props.lbCarrierInfoEquipmentInformation.equipment_length || ''}
                        />
                    </div>
                    <div className="form-h-sep"></div>
                    <div className="input-box-container grow">
                        <input type="text" placeholder="Width"
                            onInput={(e) => { props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, equipment_width: e.target.value }) }}
                            onChange={(e) => { props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, equipment_width: e.target.value }) }}
                            value={props.lbCarrierInfoEquipmentInformation.equipment_width || ''}
                        />
                    </div>
                    <div className="form-h-sep"></div>
                    <div className="input-box-container grow">
                        <input type="text" placeholder="Hieght"
                            onInput={(e) => { props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, equipment_height: e.target.value }) }}
                            onChange={(e) => { props.setLbCarrierInfoEquipmentInformation({ ...props.lbCarrierInfoEquipmentInformation, equipment_height: e.target.value }) }}
                            value={props.lbCarrierInfoEquipmentInformation.equipment_height || ''}
                        />
                    </div>
                </div>
            </div>
