...
function BillToCompanyContacts(props) {    
        ...
        $.post(props.serverUrl + '/saveContact', contact).then(async res => {
            if (res.result === 'OK') {
                if (props.selectedBillToCompanyInfo.id !== undefined) {
                    await props.setLbSelectedBillToCompanyInfo({ ...props.selectedBillToCompanyInfo, contacts: res.contacts });
                }
                ...
                await props.setLbBillToCompanyContactSearchCustomer({ ...props.customer, selectedBillToCompanyContact: res.contact, contacts: res.contacts });

                props.setLbBillToCompanyIsEditingContact(false);
            }
        });
    }
        ...
        if (window.confirm('Are you sure to delete this contact?')) {
            $.post(props.serverUrl + '/deleteContact', contact).then(async res => {
                if (res.result === 'OK') {
                    ...
                    if (props.selectedBillToCompanyContact.id !== undefined) {
                        if (props.selectedBillToCompanyContact.id === contact.id) {
                            await props.setLbSelectedBillToCompanyContact({});
                        }
                    }

                    await props.setLbBillToCompanyContactSearchCustomer({ ...props.customer, selectedBillToCompanyContact: {}, contacts: res.contacts });
    ...
    return (
        <div className="panel-content">
            ...
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'lb-bill-to-company-contacts')}><span className="fas fa-times"></span></div>
                                        ...
                                        return (
                                            <div key={index}>
                                                ...
                                                <div className="row-contact" onClick={async () => {
                                                    await props.setLbBillToCompanyContactSearchCustomer({ ...props.customer, selectedBillToCompanyContact: contact });
                                                    props.setLbBillToCompanyIsEditingContact(false);
                                                }}>
                            ...
                            <div className="input-toggle-container">
                                <input type="checkbox" id="cbox-panel-customer-contacts-primary-btn"
                                    onChange={e => {
                                        ...
                                        props.setLbBillToCompanyContactSearchCustomer({ ...props.customer, selectedBillToCompanyContact: contact });
                                    }}
                                    disabled={!props.billToCompanyIsEditingContact}
                ...
                <div className="footer">
                    <div className="left-buttons">
                        <div className="mochi-button" onClick={() => {
                            props.setLbBillToCompanyContactSearchCustomer({...props.customer, selectedBillToCompanyContact: {id: 0, customer_id: props.customer.id}});
                    ...
                    <div className="right-buttons">
                        ...
                        {
                            !props.billToCompanyIsEditingContact &&
                            <span className="fas fa-pencil-alt" onClick={() => { props.setLbBillToCompanyIsEditingContact(true) }} style={{
...
const mapStateToProps = state => {
    return {
        ...
        customer: state.customerReducers.lbBillToCompanyContactSearchCustomer,
        selectedBillToCompanyInfo: state.customerReducers.selectedbBillToCompanyInfo,
        selectedBillToCompanyContact: state.customerReducers.selectedLbBillToCompanyContact,
        billToCompanyContacts: state.customerReducers.lbBillToCompanyContacts,
        billToCompanyIsEditingContact: state.customerReducers.lbBillToCompanyIsEditingContact
    }
}
