...
function ConsigneeCompanySearch(props) {
    ...
    const rowDoubleClick = (e, customer) => {
        ...
        $.post(props.serverUrl + '/saveOrder', selected_order).then(async res => {
            ...
            closePanelBtnClick(null, 'lb-consignee-company-search');
        });
    }
    ...
    return (
        <div className="panel-content">
            ...
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'lb-consignee-company-search')}><span className="fas fa-times"></span></div>
