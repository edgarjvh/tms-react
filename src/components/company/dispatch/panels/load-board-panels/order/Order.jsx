...
function Order(props) {
    ...
    return (
        <div className="panel-content">
            ...
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'lb-order')}><span className="fas fa-times"></span></div>
                            ...
                            <div style={{
                                ...
                                <div style={{ ...styleFlexCol, justifyContent: 'center', flexGrow: 1, flexBasis: '100%' }}>
                                    ...
                                    <div style={{ ...styleFlexRow }}><span style={{ ...styleFieldName, width: '4rem' }}>E-Mail:</span> <span style={{ ...styleFieldData }}>{
                                        ((props.selected_order.carrier?.contacts || []).findIndex(el => el.is_primary === 1) === -1
                                            ? ''
                                            : props.selected_order.carrier?.contacts[props.selected_order.carrier?.contacts.findIndex(el => el.is_primary === 1)].email_work).toLowerCase()
                                    }</span></div>
                                </div>
