                    ...
                    <div className="page-block" style={{ paddingTop: '2rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gridGap: '1rem' }}>
                        <div className="form-bordered-box" style={{ border: '1px solid rgba(0,0,0,0.1)', boxShadow: '1px 1px 1px 0 rgba(0,0,0,0.8)', padding: 10 }}>
                            ...
                            <div style={{
                                ...
                                <span style={{ ...this.styleFieldName, marginRight: 10 }}>CODE:</span> <span style={{ ...this.styleFieldDataBold }}>{((this.props.selectedCustomer.code_number || 0) === 0 ? (this.props.selectedCustomer.code || '') : this.props.selectedCustomer.code + this.props.selectedCustomer.code_number).toUpperCase()}</span>
                            </div>
                        ...
                        <div className="form-bordered-box" style={{ border: '1px solid rgba(0,0,0,0.1)', boxShadow: '1px 1px 1px 0 rgba(0,0,0,0.8)', padding: 10 }}>
                            ...
                            <div style={{
                                ...
                                <span style={{ ...this.styleFieldName, marginRight: 10 }}>CODE:</span> <span style={{ ...this.styleFieldDataBold }}>{((this.props.selectedCustomer.mailing_address?.code_number || 0) === 0 ? (this.props.selectedCustomer.mailing_address?.code || '') : this.props.selectedCustomer.mailing_address?.code + this.props.selectedCustomer.mailing_address?.code_number).toUpperCase()}</span>
                            </div>
