...
import './FactoringCompanyContacts.css';
import {
    setCarrierPanels,
...
function FactoringCompanyContacts(props) {
    ...
    const borderBottomClasses = classnames({
        ...
        'disabled': !props.factoringCompanyIsEditingContact
    });
    ...
    const saveFactoringCompanyContact = () => {
        ...
        $.post(props.serverUrl + '/saveFactoringCompanyContact', contact).then(async res => {
            if (res.result === 'OK') {
                if (props.selectedFactoringCompany.id !== undefined) {
                ...
                await props.setSelectedFactoringCompanyContactSearch({ ...props.factoringCompany, selectedContact: res.contact, contacts: res.contacts });

                props.setFactoringCompanyIsEditingContact(false);
            }
        });
    }
        ...
        if (window.confirm('Are you sure to delete this contact?')) {
            $.post(props.serverUrl + '/deleteFactoringCompanyContact', contact).then(async res => {
                if (res.result === 'OK') {
                    ...
                    await props.setSelectedFactoringCompanyContactSearch({ ...props.factoringCompany, selectedContact: {}, contacts: res.contacts });
    ...
    return (
        <div className="panel-content">
            ...
            <div className="close-btn" title="Close" onClick={e => closePanelBtnClick(e, 'factoring-company-contacts')}><span className="fas fa-times"></span></div>
                                        ...
                                        return (
                                            <div key={index}>
                                                ...
                                                <div className="row-contact" onClick={async () => {
                                                    await props.setSelectedFactoringCompanyContactSearch({ ...props.factoringCompany, selectedContact: contact });
                                                    props.setFactoringCompanyIsEditingContact(false);
                                                }}>
                ...
                <div className="contact-form">
                    <div className="contact-form-header">
                        <div className="contact-avatar-container">
                            ...
                            {
                                (props.factoringCompanyIsEditingContact && (props.factoringCompany.selectedContact.id || 0) > 0 && (props.factoringCompany.selectedContact.avatar || '') !== '') && <span className="fas fa-trash-alt remove-contact-avatar-btn" onClick={removeContactAvatar}></span>
                            }
                            {
                                (props.factoringCompanyIsEditingContact && (props.factoringCompany.selectedContact.id || 0) > 0) && <span className="fas fa-sync change-contact-avatar-btn" onClick={() => { refInputAvatar.current.click() }}></span>
                            }
                        ...
                        <div className="contact-buttons">
                            <div className="input-toggle-container">
                                <input type="checkbox" id="cbox-panel-factoring-company-contacts-primary-btn"
                                    onChange={e => {
                                        let contact = props.factoringCompany.selectedContact;
                                        contact.is_primary = e.target.checked ? 1 : 0;
                                        props.setSelectedFactoringCompanyContactSearch({ ...props.factoringCompany, selectedContact: contact });
                                    }}
                                    disabled={!props.factoringCompanyIsEditingContact}
                                    checked={(props.factoringCompany.selectedContact.is_primary || 0) === 1}
                                     />
                                <label htmlFor="cbox-panel-factoring-company-contacts-primary-btn">
                    ...
                    <div className="contact-form-fields">
                        <div className="contact-form-wrapper">
                            <div className="field-container">
                                ...
                                <input ref={refPrefix} type="text" readOnly={!props.factoringCompanyIsEditingContact}
                                    onChange={e => {
                                        let contact = props.factoringCompany.selectedContact;
                            ...
                            <div className="field-container">
                                ...
                                <input type="text" readOnly={!props.factoringCompanyIsEditingContact}
                                    onChange={e => {
                                        let contact = props.factoringCompany.selectedContact;
                            ...
                            <div className="field-container">
                                ...
                                <MaskedInput
                                    ...
                                    guide={true}
                                    type="text" readOnly={!props.factoringCompanyIsEditingContact}
                                    onChange={e => {
                                        let contact = props.factoringCompany.selectedContact;
                ...
                <div className="footer">
                    <div className="left-buttons">
                        <div className="mochi-button" onClick={() => {
                            props.setSelectedFactoringCompanyContactSearch({ ...props.factoringCompany, selectedContact: { id: 0, carrier_id: props.factoringCompany.id } });
                    ...
                    <div className="right-buttons">
                        {
                            props.factoringCompanyIsEditingContact &&
                            <span className="fas fa-save" onClick={saveFactoringCompanyContact}></span>
                        }
                        {
                            !props.factoringCompanyIsEditingContact &&
                            <span className="fas fa-pencil-alt" onClick={() => { props.setFactoringCompanyIsEditingContact(true) }} style={{
...
const mapStateToProps = state => {
    return {
        ...
        factoringCompany: state.carrierReducers.selectedFactoringCompanyContactSearch,
