    ...
    const saveCarrierContact = () => {
        ...
        $.post(props.serverUrl + '/saveCarrierContact', contact).then(async res => {
            if (res.result === 'OK') {
                ...
                await props.setContactSearchCarrier({ ...props.carrier, selectedContact: res.contact, contacts: res.contacts });
        ...
        if (window.confirm('Are you sure to delete this contact?')) {
            $.post(props.serverUrl + '/deleteCarrierContact', contact).then(async res => {
                if (res.result === 'OK') {
                    ...
                    await props.setContactSearchCarrier({ ...props.carrier, selectedContact: {}, contacts: res.contacts });
                                        ...
                                        return (
                                            <div key={index}>
                                                ...
                                                <div className="row-contact" onClick={async () => {
                                                    await props.setContactSearchCarrier({ ...props.carrier, selectedContact: contact });
                                                    props.setIsEditingContact(false);
                                                }}>
                ...
                <div className="contact-form">
                    <div className="contact-form-header">
                        <div className="contact-avatar-container">
                            ...
                            {
                                (props.isEditingContact && (props.carrier.selectedContact.id || 0) > 0 && (props.carrier.selectedContact.avatar || '') !== '') && <span className="fas fa-trash-alt remove-contact-avatar-btn" onClick={removeContactAvatar}></span>
                            }
                            {
                                (props.isEditingContact && (props.carrier.selectedContact.id || 0) > 0) && <span className="fas fa-sync change-contact-avatar-btn" onClick={() => {refInputAvatar.current.click()}}></span>
                            }
                        ...
                        <div className="contact-buttons">
                            <div className="input-toggle-container">
                                <input type="checkbox" id="cbox-panel-carrier-contacts-primary-btn"
                                    onChange={e => {
                                        let contact = props.carrier.selectedContact;
                                        contact.is_primary = e.target.checked ? 1 : 0;
                                        props.setContactSearchCarrier({ ...props.carrier, selectedContact: contact });
                                    }}
                                    disabled={!props.isEditingContact}
                                    checked={(props.carrier.selectedContact.is_primary || 0) === 1} />
                                <label htmlFor="cbox-panel-carrier-contacts-primary-btn">
                ...
                <div className="footer">
                    <div className="left-buttons">
                        <div className="mochi-button" onClick={() => {
                            props.setContactSearchCarrier({...props.carrier, selectedContact: {id: 0, carrier_id: props.carrier.id}});
...
const mapStateToProps = state => {
    return {
        ...
        isEditingContact: state.carrierReducers.isEditingContact
    }
}
