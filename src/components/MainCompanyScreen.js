...
import './../styles/mainCompanyScreen.css';
...
import DispatchPage from './company-pages/DispatchPage'; 
import CustomersPage from './company-pages/CustomersPage';

function MainCompanyScreen(props) {    
    ...
    const customersBtnClick = () => {
        ...
        axios.post(props.serverUrl + '/getFullCustomers').then(async res => {            
            if (res.data.result === 'OK'){                
                ...
                res.data.customers.map(async customer => {
                    ...
                    if (customer.id === 11){
                        await props.setSelectedCustomer(customer);
                    }
            ...
            <div className="main-content">
                <div className="menu-bar">
                    ...
                    <div className="section">
                        ...
                        <div className="menu-btn" id="load-board-btn" title="Load Board"><span className="fas fa-chart-area"></span></div>
...
const mapStateToProps = state => {
    return {
        ...
        pages: state.companyScreenReducers.pages,
        selectedPageIndex: state.companyScreenReducers.selectedPageIndex,
